...
function dra() {
    var firCheA = document.getElementById("fir1").getContext("2d");
    firOne(firCheA);
    
    var watCheA = document.getElementById("wat1").getContext("2d");
    watOne(watCheA);
    
    var earCheA = document.getElementById("ear1").getContext("2d");
    earOne(earCheA);
    
    var winCheA = document.getElementById("win1").getContext("2d");
    winOne(winCheA);
    
    var firCheB = document.getElementById("fir2").getContext("2d");
    firTwo(firCheB);
    
    var watCheB = document.getElementById("wat2").getContext("2d");
    watTwo(watCheB);
    
    var earCheB = document.getElementById("ear2").getContext("2d");
    earTwo(earCheB);
    
    var winCheB = document.getElementById("win2").getContext("2d");
    winTwo(winCheB);
    
    var firCheC = document.getElementById("pan").getContext("2d");
    firTwo(firCheC);
}
...
function staClo() {
    ...
    if(staLev == 6) {
        ...
        document.getElementById("staTel").innerHTML = "STAGE " + staLev + "<br />" + "START";
    }
}

function staSta() {
    theOne();
    timInt = setInterval("timMin()", 1000);
}
...
function winOne(ctx) {
    ...
    ctx.fillStyle="gray";
    ctx.arc(25,70,20,0,Math.PI*2);
    ctx.arc(50,60,30,0,Math.PI*2);
    ctx.arc(85,65,15,0,Math.PI*2);
    ctx.fill();

    ctx.font="bold 15px Ariel";
    ctx.fillStyle="green";
    ctx.fillText("FUMES",25,70);
    ctx.closePath();
}
...
function firTwo(ctx) {
    ...
    ctx.fillText("Calling",5,35);
    ctx.fillText("The",15,60);
    ctx.fillText("911!!",25,85);
...
function winTwo(ctx) {
    ...
    ctx.fillRect(42,45,16,50);
    ctx.fillStyle="#008000";
    ctx.arc(25,40,20,0,Math.PI*2);
...
function theOneHey(temId, colWha) {
    ...
    if(colWha == "#000000") {
        peoOne(ctx);
    } else if(colWha == "#ff0000") {
        firOne(ctx);
    } else if(colWha == "#87ceeb") {
        watOne(ctx);
    } else if(colWha == "#ffff00") {
        earOne(ctx);
    } else if(colWha == "#008000") {
        winOne(ctx);
    }
}
    ...
    if(cheOne == colIs) {
        ...
        if(sco >= goa) {
            ...
            switch(staLev) {
                ...
                case 5:
                    staClo();
                    alert("You Heal the whole World!");
                    break;
            }
        }
    } else {
        document.getElementById("logBox").innerHTML = "not enough one!";
    }
}
...
function worMapWri() {
    ...
    //OCEANIA
    ctx.beginPath();
    ctx.arc(364,491,40,0,Math.PI*2);
    ctx.closePath();
    ctx.stroke();
